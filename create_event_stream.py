...
def verify_auth(client_id, api_key):
    ...
    for domain in region_domains:
        version_url = 'https://{}/v1/version'.format(domain)
        request = requests.get(version_url, auth=(client_id, api_key))
...
all_events = [1003, 1004, 1005, 553648130, 553648135, 553648136, 553648137, 553648143, 553648145,
              553648146, 553648147, 553648149, 553648150, 553648151, 553648152, 553648154,
              553648155, 553648158, 553648166, 553648168, 553648170, 553648171, 553648173,
              553648176, 553648179, 553648195, 553648196, 553648197, 554696714, 554696715,
              554696756, 554696757, 570425394, 570425396, 570425397, 570425398, 570425399,
              1090519054, 1090519081, 1090519084, 1090519089, 1090519096, 1090519097, 1090519103,
              1090519105, 1090519107, 1090524040, 1090524041, 1091567628, 1091567670, 1107296257,
              1107296258, 1107296260, 1107296261, 1107296262, 1107296263, 1107296264, 1107296265,
              1107296266, 1107296267, 1107296268, 1107296269, 1107296270, 1107296271, 1107296272,
              1107296273, 1107296274, 1107296275, 1107296276, 1107296277, 1107296278, 1107296279,
              1107296280, 1107296281, 1107296282, 1107296283, 1107296284, 2164260866, 2164260880,
              2164260884, 2164260889, 2164260892, 2164260893, 2164260895, 2164260903, 2164260910,
              2164260911, 2164260914, 2164260922, 2164260931, 2165309453, 2165309495, 2181038130]
...
post_req = requests.post(url, headers=headers, data=json.dumps(payload), auth=(client_id, api_key))
